...
Partial Class InformacionFeDeBautismo
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(InformacionFeDeBautismo))
        Button2 = New Button()
        Button1 = New Button()
        Label1 = New Label()
        ...
        Button1.TabIndex = 49
        Button1.Text = "Agregar nueva fe de bautismo"
        ...
        ' TextBox1
        ' 
        TextBox1.Location = New Point(182, 105)
        ...
        btnEliminar.Width = 63
        ' 
        ' InformacionFeDeBautismo
        ' 
